...
<Frame>
  <img
    src="/images/compflowlab_logo_light.png"
    alt="Compflowlab Logo Dark"
    title="Compflowlab Logo Dark"
    lightAlt="Compflowlab Logo Light"
    darkAlt="Compflowlab Logo Dark"
    className="dark:hidden"
  />
  <img
    src="/images/compflowlab_logo_dark.png"
    alt="Compflowlab Logo Dark"
    title="Compflowlab Logo Dark"
    lightAlt="Compflowlab Logo Light"
    darkAlt="Compflowlab Logo Dark"
